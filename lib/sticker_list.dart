...
import 'package:SmileInPain/utils.dart';
import 'package:SmileInPain/sticker_pack_info.dart';
      ...
      children: <Widget>[
        ...
        Center(
          child: Padding(
            ...
            child: Text(
                "All the stickers are collected from different sources, If you own any of it, go to the github repo and add yourself as an author. New Stickers will also be accepted."),
          ),
        ),
        Center(
          child: new InkWell(
              ...
              onTap: () => launch(
                  'https://github.com/thesmallstar/SmileInPain-StickersApp')),
        ),
      ],
    );
  }
